...
Ten widget udostępnia dynamiczny obrazek wyglądający jak pasek postępu
z systemu Mac OS 9. Jest opakowany w cztery ramki (Frame): północną,
południową, wschodnią i zachodnią, w których można umieszczać
dodatkowe widgety. Na przykład Tk::Copy::Mac używa kilku etykiet
(Label) i widgetu CollapsableFrame do stworzenia w miarę podobnego do
